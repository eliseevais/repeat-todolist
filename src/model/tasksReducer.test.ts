...
test('array should be created for new todolist', () => {
  ...
  const endState = tasksReducer(startState, createTodolistAC({title: 'New todolist', id: newTodolistId}))
...
test('correct task should change its title', () => {
  const endState = tasksReducer(
    startState,
    changeTaskTitleAC({ todolistId: 'todolistId1', taskId: '1', title: 'HTML'})
  )
